...
void Triangulo :: CriarTriangulo(Ponto* p1,Ponto* p2,Ponto* p3)
{
    ...
    float vetorp1p2[3];
    vetorp1p2[0]=*this->pontos[1]->GetPvista()-*this->pontos[0]->GetPvista();
    vetorp1p2[1]=*(this->pontos[1]->GetPvista()+1)-*(this->pontos[0]->GetPvista()+1);
    vetorp1p2[2]=*(this->pontos[1]->GetPvista()+2)-*(this->pontos[0]->GetPvista()+2);


    float vetorp1p3[3];
    vetorp1p3[0]=*this->pontos[2]->GetPvista()-*this->pontos[0]->GetPvista();
    vetorp1p3[1]=*(this->pontos[2]->GetPvista()+1)-*(this->pontos[0]->GetPvista()+1);
    vetorp1p3[2]=*(this->pontos[2]->GetPvista()+2)-*(this->pontos[0]->GetPvista()+2);
